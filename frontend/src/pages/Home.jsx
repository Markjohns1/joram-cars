                    ...
                    <div className="container-premium relative z-10">
                        <div className="max-w-2xl">
                            ...
                            <div className="flex flex-col gap-4 mt-8 w-full max-w-lg">
                                {/* Premium Search Box */}
                                <div className="flex items-center h-16 bg-slate-900/80 backdrop-blur-sm rounded-xl border border-slate-700/50 hover:border-slate-500 focus-within:border-blue-500 transition-all duration-300 overflow-hidden shadow-2xl">
                                    ...
                                    <input
                                        ...
                                        className="bg-transparent border-none outline-none ring-0 focus:ring-0 focus:outline-none flex-1 text-white placeholder:text-slate-500 font-medium text-lg px-4 h-full w-full"
                                    />
                                    <button
                                        onClick={handleSearch}
                                        className="h-full px-6 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-wider text-xs flex items-center justify-center transition-colors shrink-0"
                                    >
                                        Search
                                    </button>
                                </div>
                                ...
                                <div className="flex flex-col sm:flex-row items-center gap-4">
                                    <button
                                        ...
                                        className="w-full sm:w-auto h-14 px-8 rounded-xl bg-white text-slate-900 font-bold uppercase tracking-widest text-xs transition-all duration-300 hover:bg-blue-50 flex items-center justify-center gap-2 group shadow-xl"
                                    >
                                        Visit Showroom
                                        <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
                                    </button>

                                    <div className="flex items-center gap-2 px-4 py-2 bg-slate-900/40 backdrop-blur-md rounded-lg border border-white/5">
                                        <span className="flex h-1.5 w-1.5 rounded-full bg-green-500 animate-pulse" />
                                        <span className="text-white/60 text-[10px] font-black uppercase tracking-widest whitespace-nowrap">Premium Units Available</span>
                                    </div>
                                </div>
                            </div>
                        </div>
